  ...
  <div class="card-body">
    ...
    <form action="{{ url('doctors/'.$doctor->id) }}" method="post">
      ...
      <div class="form-group">
        ...
        <input type="text" name="dni" class="form-control" required value="{{ old('dni', $doctor->dni)}}">
      </div>
      <div class="form-group">
        <label for="address">Dirección</label>
        <input type="text" name="address" class="form-control" required value="{{ old('address', $doctor->address)}}">
      </div>
      <div class="form-group">
